...
def add_ssod_at_config(cfg):
    """
    Add config for ssod_at.
    """
    _C = cfg
    ...
    # dataloader
    # supervision level
    _C.DATALOADER.SUP_PERCENT = 5.0  # 5 = 5% dataset as labeled set
    _C.DATALOADER.RANDOM_DATA_SEED = 1  # random seed to read data
    _C.DATALOADER.RANDOM_DATA_SEED_PATH = ""
